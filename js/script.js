window.addEventListener("DOMContentLoaded",()=>{
    ...
    if(window.getComputedStyle(document.querySelector('body')).width.replace(/[A-Za-z]/g, '')<=576){
        video.remove();
    ...
    sliders('.slider1__inner', '.slider1__slide', '.slider1-item', '.slider1__next-btn-wrapper', '.slider1__prev-btn-wrapper', '.slider1__wrapper');
    sliders('.slider2__inner', '.slider2__slide', '.slider2-item', '.slider2__next-btn-wrapper', '.slider2__prev-btn-wrapper', '.slider2__wrapper');
    sliders('.slider3__inner', '.slider3__slide', '.slider3-item', '.slider3__next-btn-wrapper', '.slider3__prev-btn-wrapper', '.slider3__wrapper');


    ///// modals
    const consultBtn1 = document.querySelector('.consult-backgr-dark-btn-wrapper'),
        consultBtn2 = document.querySelector('.service-btn-wrapper'),
        questionBtn = document.querySelector('.header__nav-wrapper-question-wrapper'),
    ...
    document.addEventListener('keydown', (e)=>{
        if (consultForm.style.display == 'block' || questionForm.style.display == 'block' || thanksForm.style.display == 'block' || errorForm.style.display == 'block' || priceForm.style.display == 'block') {
            if (e.code == "Escape") {
                hideForms();
            }
        }
